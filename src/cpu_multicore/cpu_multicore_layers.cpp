...
bool CPUMulticoreMaxPool2D::forward(const float* input, const std::vector<int>& input_shape,
    ...
    // Parallelize batch and channel loops
...
CPUMulticoreLinear::CPUMulticoreLinear(const float* weights, const float* bias,
...
bool CPUMulticoreSoftmax::forward(const float* input, const std::vector<int>& input_shape,
                                  float* output, std::vector<int>& output_shape) {
